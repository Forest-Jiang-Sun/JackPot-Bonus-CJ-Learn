...
public class BetButton extends Component {
    ...
    public BetButton(String skin, int index, int multi) {
        btnState = 0;
        skinPath = skin;
        btnIndex = index;
        multipler = multi;
    ...
    private void init() {
        for (int i=0; i<NUM_SKINS; ++i) {
            ...
            Vector2 point = CoordinateLoader.getInstance().getCoordinate(bgSprites[i], "BetButton" + (btnIndex+1));
        ...
        for (int i=0; i<NUM_SKINS; ++i) {
            ...
            Vector2 point = CoordinateLoader.getInstance().getCoordinate(creditSprites[i], "BetButton" + (btnIndex+1));
