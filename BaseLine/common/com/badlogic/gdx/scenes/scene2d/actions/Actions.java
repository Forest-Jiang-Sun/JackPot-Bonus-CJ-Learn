...
public class Actions {
    ...
    static public SequenceAction flash(float duration) {
        return sequence(delay(duration, hide()), delay(duration, show()));
    }

    static public SequenceAction scales(float scale, float duration) {
        return sequence(scaleTo(scale,scale, duration), scaleTo(1.0f, 1.0f, duration));
    }
}
